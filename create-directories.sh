...
Chronicles1=( 54 55 24 43 26 81 40 40 44 14 47 40 14 17 29 43 27 17 19 8 30 19 32 31 31 32 34 21 30 )
Chronicles2=( 17 18 17 22 14 42 22 18 31 19 23 16 22 15 19 14 19 34 11 37 20 12 21 27 28 23 9 27 36 27 21 33 25 33 27 23 )
...
John3=( 14 )
Jude=( 25 )
Revelation=( 20 29 22 11 14 17 17 13 21 11 19 17 18 20 8 21 18 24 21 15 27 20 )
...
do
	...
	#copy in the redirect script
	cp redirect.html "$book/index.html"

	#loop chapters
	for verseCounter in "${!bookVerses}"
	do
		min=1
		max=$verseCounter

		#create chapter dir
		mkdir "$book/$chapterCounter"

		#copy in the redirect script
		cp redirect.html "$book/$chapterCounter/index.html"

		#loop verses
		while [ $min -le $max ]; do
			#create verse dir
			mkdir "$book/$chapterCounter/$min"

			#copy in the redirect script
			cp redirect.html "$book/$chapterCounter/$min/index.html"
...
mv Kings1 1\ Kings
mv Kings2 2\ Kings
mv Chronicles1 1\ Chronicles
mv Chronicles2 2\ Chronicles
mv SongofSongs Song\ of\ Songs

mv Corinthians1 1\ Corinthians
mv Corinthians2 2\ Corinthians
mv Thessalonians1 1\ Thessalonians
mv Thessalonians2 2\ Thessalonians
mv Timothy1 1\ Timothy
mv Timothy2 2\ Timothy
mv Peter1 1\ Peter
mv Peter2 2\ Peter
mv John1 1\ John
mv John2 2\ John
