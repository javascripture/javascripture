...
const Eye = ( { fill } ) => (
	<svg version="1.1" width="20" height="20" viewBox="0 0 20 20">
		<path d="M10 4.4c-6.561 0-10 4.833-10 5.6s3.439 5.6 10 5.6 10-4.833 10-5.6-3.439-5.6-10-5.6zM10 14.308c-2.454 0-4.444-1.929-4.444-4.308s1.99-4.308 4.444-4.308c2.455 0 4.445 1.929 4.445 4.308s-1.99 4.308-4.445 4.308zM10 10c-0.406-0.446 0.664-2.153 0-2.153-1.227 0-2.222 0.964-2.222 2.153s0.995 2.154 2.222 2.154c1.228 0 2.223-0.965 2.223-2.154 0-0.546-1.876 0.38-2.223 0z" fill={ fill }></path>
	</svg>
);
